    ...
    <>
      <header className="flex justify-between py-2 pl-8 border border-gray-100 items-center fixed top-0 left-0 bg-white w-full h-14">
        <div className="left-side">
          <div className="logo text-xl font-bold">Blog - Posts</div>
        </div>
        ...
        <div className="right-side flex gap-4 items-center">
          ...
          <button className="border-none bg-blue-500 rounded-sm flex items-center text-white py-2 px-3 hover:bg-purple-600">
      ...
      >
        <div>
          <div className="bg-blue-500  rounded-md p-6 flex items-center">
            <TabCoinIcon className="text-white h-16" />
            <span className="text-white font-bold text-3xl ml-4">
              860 T$
            </span>
          </div>
          ...
          <aside className="col-span-3">
            <div className="sticky top-20 flex justify-center w-full">
              <div className="ad bg-gray-100 p-8 rounded-md flex justify-center items-center flex-col max-w-xs">
                <img
                  src="https://media-exp1.licdn.com/dms/image/C4E03AQGy9Uo-rPM6RA/profile-displayphoto-shrink_100_100/0/1528046852781?e=1640217600&v=beta&t=_6q3EiL8ePcBJghFiwEV6MOhmuz0FEWPXCP5k-uP5CE"
                  className="rounded-md w-3/5"
                />
                <h3 className="font-bold text-2xl mt-4">Carlos Gatti</h3>
                <p className="text-sm text-gray-600 text-center leading-5 mt-1">
                  Full Stack Engineer
                </p>
                <button className="bg-blue-600 text-white flex items-center px-4 py-2 rounded-md mt-4">
                  <FiLinkedin size={20} className="mr-2" />
                  <span>Connect</span>
                </button>

                <div className="flex items-center text-gray-500 mt-6">
                  <FiInfo className="mr-1" size={16} />
                  <span className="text-xs">Ad by Carlos</span>
                </div>
              </div>
            </div>
          </aside>
